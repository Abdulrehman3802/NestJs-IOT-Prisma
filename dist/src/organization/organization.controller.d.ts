...
export declare class OrganizationController {
    ...
    findInterval(id: string): Promise<import("../../core/generics/api-response.dto").ApiResponseDto<import("./dto/response/response-organization.dto").ResponseOrganizationInterval>>;
    ...
    uploadFile(req: RequestWithUser, file: any, body: any): Promise<string>;
}
