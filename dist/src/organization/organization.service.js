...
let OrganizationService = class OrganizationService {
    constructor(organizationRepository, userService, roleService) {
    ...
    async create(createOrganizationDto, userid) {
        try {
            const organizationModel = Object.assign(Object.assign({}, createOrganizationDto), { is_active: true, created_by: userid, updated_by: userid, date_created: new Date(), date_updated: new Date() });
