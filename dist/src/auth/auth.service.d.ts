...
export declare class AuthService {
    ...
    constructor(userRepository: UserRepository, rolesRepository: RolesRepository, organizationRepository: OrganizationRepository, facilityRepository: FacilityRepository, departmentRepository: DepartmentRepository, configService: ConfigService, jwtService: JwtService, emailService: EmailService);
